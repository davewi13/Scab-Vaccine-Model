...
model <- SISe_sp(u0 = u0, tspan = 1:365, events = NULL, phi = 0,
                 upsilon = (0.0002519243), gamma = (1/77), alpha = 0.005619795, qprop = (1/2), tau = (1/653), epar = (1/3), beta_t1 = 0.06832791,
...
prevfarms <- prevalence(model = result, formula = I + C ~ S + I + C, type = "nop" )
withinnodeprev <- prevalence(model = result, formula = I + C ~ S + I + C, type = "wnp")
